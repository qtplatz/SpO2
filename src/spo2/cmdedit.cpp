    ...
    namespace detail {
        ...
        public:
            ...
            void operator()( const pugi::xpath_node& node, QTextFrame * pframe = 0, int level = 0 ) const {
                ...
                QObject::connect( frame, &QTextFrame::destroyed, &edit, &cmdEdit::handleBlockDeleted );
...
cmdEdit::cmdEdit(QWidget *parent) : QTextEdit(parent)
                                  , completer_(0)
{
}

void
cmdEdit::setCompleter(QCompleter *completer)
{
    if (completer_)
    ...
    connect( completer_, static_cast<void(QCompleter::*)(const QString&)>(&QCompleter::activated), this, &cmdEdit::insertCompletion );
}

QCompleter *
cmdEdit::completer() const
{
    return completer_;
}

void
cmdEdit::insertCompletion(const QString& completion)
{
...
void
cmdEdit::focusInEvent(QFocusEvent *e)
{
    if (completer_)
        completer_->setWidget( this );
...
void
cmdEdit::keyPressEvent(QKeyEvent *e)
{
...
void
cmdEdit::contextMenuEvent( QContextMenuEvent * e )
{
